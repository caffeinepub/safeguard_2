...
export class Backend implements backendInterface {
    ...
    async getEmergencyContact(): Promise<EmergencyContact> {
        if (this.processError) {
            try {
                const result = await this.actor.getEmergencyContact();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setEmergencyContact(arg0: EmergencyContact): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setEmergencyContact(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
